...
urlpatterns = [
    ...
    path("company/profile/edit/", views.company_profile_edit, name="accounts.company_profile_edit"),
    path("companies/", views.company_search, name="accounts.company_search"),
    path("company/<str:username>/", views.company_profile, name="accounts.company_profile"),
