...
class Application(models.Model):
    ...
    rejection_feedback_template = models.CharField(max_length=40, blank=True, default="")
    rejection_feedback_note = models.TextField(blank=True, default="")
    rejection_feedback_sent_at = models.DateTimeField(blank=True, null=True)
